# PASO 6: CORREGIR TESTS - VERSION CON MOCKS
# Ejecutar: powershell.exe -ExecutionPolicy Bypass -File .\CORREGIR_TESTS_PASO_06.ps1

Write-Host ""
Write-Host "PASO 6: CORRIGIENDO TESTS (Agregando Mocks)" -ForegroundColor Cyan
Write-Host ""
...
# TEST CORREGIDO 1: EquipmentControllerTest
$test1 = @'
...
# TEST CORREGIDO 2: MaintenanceControllerTest
$test2 = @'
package com.thoth.adapter.in.rest.controller;
...
# TEST CORREGIDO 3: GlobalExceptionHandlerTest
$test3 = @'
...
Write-Host "  ✓ Agregados Mocks (@MockBean)" -ForegroundColor Cyan
Write-Host "  ✓ Agregado ObjectMapper" -ForegroundColor Cyan
Write-Host "  ✓ Tests con requests válidos" -ForegroundColor Cyan
Write-Host "  ✓ Tests con requests inválidos" -ForegroundColor Cyan
