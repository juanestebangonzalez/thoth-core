# PASO 6: FINAL VERSION - SIN BOM (Byte Order Mark)
# Ejecutar: powershell.exe -ExecutionPolicy Bypass -File .\CREAR_PASO_06_FINAL.ps1

Write-Host ""
Write-Host "PASO 6: REST API CONTROLLERS - VERSION FINAL" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "Creando archivos (sin BOM)..." -ForegroundColor Yellow
Write-Host ""

# Funcion para escribir archivos UTF-8 sin BOM
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\exception\ResourceNotFoundException.java" -Content $file1
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\exception\ValidationException.java" -Content $file2
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\exception\UnauthorizedException.java" -Content $file3
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\exception\ForbiddenException.java" -Content $file4
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\exception\ApiErrorResponse.java" -Content $file5
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\dto\request\CreateEquipmentRequest.java" -Content $file6
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\dto\request\UpdateEquipmentRequest.java" -Content $file7
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\dto\request\ChangeStatusRequest.java" -Content $file8
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\dto\request\LocationRequest.java" -Content $file9
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\dto\request\CreateMaintenanceRequest.java" -Content $file10
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\dto\request\CompleteMaintenanceRequest.java" -Content $file11
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\dto\response\LocationDTO.java" -Content $file12
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\dto\response\EquipmentResponseDTO.java" -Content $file13
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\dto\response\MaintenanceResponseDTO.java" -Content $file14
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\dto\response\ApiSuccessResponse.java" -Content $file15
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\dto\response\PagedResponse.java" -Content $file16
...
'@
Write-UTF8NoBOM -Path "$basePath\config\SpringDocOpenApiConfig.java" -Content $file17
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\exception\GlobalExceptionHandler.java" -Content $file18
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\controller\EquipmentController.java" -Content $file19
...
'@
Write-UTF8NoBOM -Path "$basePath\adapter\in\rest\controller\MaintenanceController.java" -Content $file20
...
'@
Write-UTF8NoBOM -Path "$testPath\adapter\in\rest\controller\EquipmentControllerTest.java" -Content $file21
...
'@
Write-UTF8NoBOM -Path "$testPath\adapter\in\rest\controller\MaintenanceControllerTest.java" -Content $file22
...
'@
Write-UTF8NoBOM -Path "$testPath\adapter\in\rest\exception\GlobalExceptionHandlerTest.java" -Content $file23
...
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "23 archivos creados (UTF-8 sin BOM):" -ForegroundColor Green
